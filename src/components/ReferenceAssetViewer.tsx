          ...
          <div className="flex items-center justify-between px-5 sm:px-6 py-3.5 border-b border-[#292524] bg-[#292524]/70">
            <div className="flex items-center gap-3">
              {activeAsset.type === 'video' && (
                <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-mono font-semibold bg-[#C4703F] text-white">
              ...
              {activeAsset.type === 'image' && (
                <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[11px] font-mono font-semibold bg-[#44403C] text-[#E7E5E4]">
                  <ImageIcon className="w-3 h-3 text-[#C4703F]" />
          ...
          <div className="relative flex-1 min-h-[320px] sm:min-h-[460px] max-h-[60vh] bg-[#0C0A09] flex items-center justify-center p-2 sm:p-6 overflow-hidden">
            ...
            {assetsList.length > 1 && (
              <>
                <button
                  onClick={handlePrev}
                  className="absolute left-3 top-1/2 -translate-y-1/2 p-2.5 rounded-full bg-[#1C1917]/80 hover:bg-[#C4703F] text-white border border-[#44403C] transition-all shadow-lg hover:scale-105"
                ...
                <button
                  onClick={handleNext}
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-2.5 rounded-full bg-[#1C1917]/80 hover:bg-[#C4703F] text-white border border-[#44403C] transition-all shadow-lg hover:scale-105"
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1.5 flex-wrap">
                  ...
                  {activeAsset.resolution && (
                    <span className="px-2 py-0.5 rounded text-[10px] font-mono text-[#C4703F] bg-[#C4703F]/10 border border-[#C4703F]/30">
                      {activeAsset.resolution}
                    </span>
                  )}
                </div>
                  ...
                  return (
                    <button
                      ...
                      className={`relative shrink-0 w-16 h-12 rounded-md overflow-hidden border transition-all ${
                        isSelected
                          ? 'border-[#C4703F] ring-2 ring-[#C4703F]/40 scale-105'
