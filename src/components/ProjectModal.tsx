      ...
      {project && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-3xl bg-[#FBFAF7] text-[#111111] z-10 rounded-[4px] border border-black/10 shadow-2xl my-auto max-h-[90vh] flex flex-col outline-none"
          >
            ...
            {/* Pinned footer — navigation + actions always on screen */}
